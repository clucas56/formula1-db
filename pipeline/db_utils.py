...
def setup_logging(script_name):
    #Set up logging to both file and console. Logs are separated by script into subfolders.
...
def upsert(conn, table, data, conflict_column):
    #Insert a record, update if it already exists. Prevents duplicate data on re-runs.
